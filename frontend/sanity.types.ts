...
// Source: sanity/lib/queries.ts
// Variable: postSettingsQuery
// Query: *[_type == "postSettings"][0]
export type PostSettingsQueryResult = {
  _id: string
  _type: 'postSettings'
  _createdAt: string
  _updatedAt: string
...
// Source: sanity/lib/queries.ts
// Variable: postCategoriesQuery
// Query: *[_type == "postCategory"] | order(title asc) {    _id,    title,    "slug": slug.current,    description  }
export type PostCategoriesQueryResult = Array<{
  _id: string
  title: string
  slug: string
